...
final class ReviewDatabaseManagerUnitTests: XCTestCase {
    ...
    func test_createReview_Success() {
        ...
        sut1.createMedia(id: testId, title: testTitle, overview: "", type: "movie", posterURL: "", backdropURL: "", genres: [], releaseDate: "", watchedDate: nil, creators: [], casts: [], addedDate: Date(), certificate: "", runtimeOrEpisodeInfo: "")
            .flatMap { [weak self] mediaObjectID -> Single<NSManagedObjectID> in
                ...
                return self.sut2.createReview(testId, rating: testRating, review: testReview, comment: testComment, quote: testQuote)
            }
