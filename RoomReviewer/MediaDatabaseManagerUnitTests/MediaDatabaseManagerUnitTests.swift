...
final class MediaDatabaseManagerUnitTests: XCTestCase {
    ...
    func test_createMedia_Success() {
        ...
        sut.createMedia(id: testId, title: testTitle, overview: "", type: "movie", posterURL: nil, backdropURL: nil, genres: [], releaseDate: "", watchedDate: nil, creators: [], casts: [], addedDate: Date(), certificate: "", runtimeOrEpisodeInfo: "")
    ...
    func test_deleteMedia_Success() {
        ...
        sut.createMedia(id: testId, title: testTitle, overview: "", type: "movie", posterURL: nil, backdropURL: nil, genres: [], releaseDate: "", watchedDate: nil, creators: [], casts: [], addedDate: Date(), certificate: "", runtimeOrEpisodeInfo: "")
            .flatMap { [weak self] createdObjectID -> Single<Void> in
                ...
                guard let self = self else {
                    XCTFail("실패")
                    return .error(DatabaseError.commonError)
                }
